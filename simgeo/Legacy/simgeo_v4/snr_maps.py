...
Output: G:/geophone_synth/config/snr_maps_v4.npz. Resume-aware (per-profile npy chunks).
Usage: python simgeo_v4/snr_maps.py [nworkers=15]
"""
...
CFG_DIR = r"G:/geophone_synth/config"
CHUNKS = os.path.join(CFG_DIR, "snr_maps_v4_chunks")
OUT_NPZ = os.path.join(CFG_DIR, "snr_maps_v4.npz")
