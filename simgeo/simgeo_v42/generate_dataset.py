"""Production dataset generator — GENERATION_PLAN_V2 (~171k scenes). Adapts the v1 generator:
...
sources_v2.py. NO ADC quantizer. v1 dataset (dataset_150k shards) is never touched.
Usage: python generate_dataset.py <n_scenes> <out_dir> <nworkers>
"""
...
def main():
    ...
    out_dir = sys.argv[2] if len(sys.argv) > 2 else os.path.join(SYNTH_ROOT, "dataset_v2")
