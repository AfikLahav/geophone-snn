...
profile crosses splits. Stratified per family. Writes simgeo_banks/splits_90_10.json
...
LIB = os.path.join(HERE, "..", "simgeo_banks", "library.json")
OUT = os.path.join(HERE, "..", "simgeo_banks", "splits_90_10.json")
SEED = 20260613
